	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		try{
            ...
            while(SDP1880SenderResult.next()) {
            	...
            	System.out.print("Sending 1880 Messages" + SDP1880SenderResult.getString("msisdn") + " "
            			+ SDP1880SenderResult.getString("shortCode") + " " 
            			+ SDP1880SenderResult.getString("message") + " End \n");
            } 
            
            SDP1880SenderResult.close();
		...
		try{
	        ...
	        if (sdp1880Connection.SDP1880DBConnection() != null) {
	         ...
	         if (SDP1880SenderCallableStatement != null){
	        	 ...
	        	 SDP1880SenderCallableStatement = null;
	        }
	         
	         if(SDP1880SenderResult != null){
	        	 SDP1880SenderResult.close();
	        	 SDP1880SenderResult = null;
	         }
		} catch(Exception ex){
			ex.printStackTrace();
		}
