...
public class SDPSmsResponse {
    ...
    {
        StringBuilder sb = new StringBuilder("<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:loc=\"http://www.csapi.org/schema/parlayx/sms/notification/v2_2/local\">");
         sb.append(" <soapenv:Header/>")
         .append(" <soapenv:Body> ")
         .append("  <loc:notifySmsDeliveryReceiptResponse/>")         
         .append("  </soapenv:Body> ")
         .append("  </soapenv:Envelope>");
        return sb.toString();     
